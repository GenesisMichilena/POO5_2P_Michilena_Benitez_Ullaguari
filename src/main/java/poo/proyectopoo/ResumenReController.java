...
import poo.proyectopoo.clases.Vuelo;
    ...
    /**
     * Clase controladora FXML para la pantalla de resumen de reserva.
     *
     * Esta clase controladora maneja la lógica de la pantalla de resumen de reserva.
...
public class ResumenReController implements Initializable {
    ...
    /**
     * Muestra la información del vuelo de ida en la interfaz.
     */
